                  ...
                  <div className="lg:col-span-3 space-y-6 sm:space-y-8">
                    ...
                    <div className="space-y-6 max-w-md">
                      <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                        ...
                        sport. I combine creativity, discipline, and
                        problem-solving to build digital products that make an
                        impact.
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-8">
                    <div>
                      ...
                      <p className="text-muted-foreground mt-3 text-base sm:text-lg max-w-2xl">
                        A curated selection of products I’ve built, designed,
                        and refined — where creativity meets execution, and
                        ideas become tools that actually work.
                      </p>
                    </div>
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="space-y-6">
                      <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                        ...
                        and conversations about technology and business.
                      </p>
